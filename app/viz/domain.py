...
class Domain(PlotManager):
    ...
    def __init__(self, datasources, plot):
    ...
    def create_and_store(self):
        ...
        p = figure(plot_width=400, plot_height=400,
            title="Domains Sorted by Relevance", y_range = y_range,
            tools='reset, resize, save')

        p.rect(y='index', x='crawled_half', height=0.75, width='crawled', color="red", fill_color="red", source = self.source, legend="crawled")
        p.rect(y='index', x='relevant_half', height=0.75, width='relevant', color="blue", fill_color="blue", source = self.source, legend="relevant")
