...
class Domain(PlotManager):
    ...
    def __init__(self, crawl, datasources, plot, sort='crawled'):
        ...
        self.crawled_data = os.path.join(CRAWLS_PATH, crawl.id, datasources['crawled'].data_uri)
        self.relevant_data = os.path.join(CRAWLS_PATH, crawl.id, datasources['relevant'].data_uri)
